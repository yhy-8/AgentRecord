...
class JournalTests(unittest.TestCase):
    ...
    def test_lists_reference_sources_by_type_and_keyword(self):
        ...
        old = weekly_dir / "2026-06-29_to_2026-07-05.md"
        latest = weekly_dir / "2026-07-06_to_2026-07-12.md"
        ...
        self.assertEqual("分析周报 | 2026-07-06 至 2026-07-12", sources[0][0])
        self.assertEqual([("分析周报 | 2026-06-29 至 2026-07-05", old)], filtered)
    ...
    def test_appends_portable_reference_with_note_and_timestamp(self):
        ...
        label = "分析周报 | 2026-07-06 至 2026-07-12"
        fixed_now = datetime.datetime(2026, 7, 15, 14, 32)

        with patch("journal.datetime.datetime") as mock_datetime:
